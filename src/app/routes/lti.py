...
from app.core.lti_core.lti_utils import (
    extract_passback_params,
    get_custom_params,
    get_role,
)
...
def lti_route():
    ...
    if check_request(request):
        ...
        user_id = (
            f"{username}_{temporary_user_params.get('tool_consumer_instance_guid', '')}"
        )
